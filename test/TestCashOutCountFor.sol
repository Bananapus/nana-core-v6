...
contract CashOutCountForWrapper {
    function cashOutCountFor(
        ...
        return JBCashOuts.cashOutCountFor(surplus, desiredOutput, totalSupply, cashOutTaxRate);
    }
}

/// @title TestCashOutCountFor
/// @notice Tests for JBCashOuts.cashOutCountFor — the inverse of the bonding curve.
contract TestCashOutCountFor is Test {
    ...
    function test_zeroDesiredOutput() public pure {
        assertEq(JBCashOuts.cashOutCountFor(100 ether, 0, 1000e18, 5000), 0);
    }

    function test_desiredOutputEqualsSurplus() public pure {
        uint256 count = JBCashOuts.cashOutCountFor(100 ether, 100 ether, 1000e18, 5000);
    ...
    function test_desiredOutputExceedsSurplus() public pure {
        uint256 count = JBCashOuts.cashOutCountFor(100 ether, 200 ether, 1000e18, 5000);
        assertEq(count, 1000e18, "Should return totalSupply when desiredOutput > surplus");
    }

    function test_maxTaxRate_reverts() public {
        vm.expectRevert(JBCashOuts.JBCashOuts_DesiredOutputNotAchievable.selector);
        wrapper.cashOutCountFor(100 ether, 50 ether, 1000e18, MAX_TAX);
    }
    ...
    function test_zeroTaxRate() public pure {
        ...
        uint256 count = JBCashOuts.cashOutCountFor(100, 25, 200, 0);
        assertEq(count, 50);
    ...
    function test_zeroTaxRate_roundsUp() public pure {
        ...
        uint256 count = JBCashOuts.cashOutCountFor(7, 2, 100, 0);
    ...
    function test_zeroSurplus() public pure {
        ...
        uint256 count = JBCashOuts.cashOutCountFor(0, 1, 1000e18, 5000);
    ...
    function test_halfTax_knownValues() public pure {
        ...
        uint256 count = JBCashOuts.cashOutCountFor(100, 37, 100, 5000);
        assertEq(count, 50);
    ...
    function test_lowTax() public pure {
        ...
        uint256 count = JBCashOuts.cashOutCountFor(1000, forwardResult, 1000, 1000);
    ...
    function test_highTax() public pure {
        ...
        uint256 count = JBCashOuts.cashOutCountFor(1000, forwardResult, 1000, 9000);
    ...
    function test_realisticValues() public pure {
        ...
        uint256 count = JBCashOuts.cashOutCountFor(surplus, forwardResult, totalSupply, taxRate);
    ...
    function test_smallSurplus_largeTotalSupply() public pure {
        ...
        uint256 count = JBCashOuts.cashOutCountFor(surplus, desiredOutput, totalSupply, taxRate);
        assertGe(JBCashOuts.cashOutFrom(surplus, count, totalSupply, taxRate), desiredOutput);
    }

    // =========================================================================
    // Round-trip: cashOutCountFor(S, cashOutFrom(S, c, T, r), T, r) <= c
    // =========================================================================
    ...
    function testFuzz_roundTrip_inverseOfForward(
        ...
        uint256 recoveredCount = JBCashOuts.cashOutCountFor(surplus, output, totalSupply, cashOutTaxRate);
    ...
    // =========================================================================
    // Correctness: cashOutFrom(S, cashOutCountFor(S, out, T, r), T, r) >= out
    // =========================================================================
    ...
    function testFuzz_correctness_outputMeetsTarget(
        ...
        uint256 count = JBCashOuts.cashOutCountFor(surplus, desiredOutput, totalSupply, cashOutTaxRate);
    ...
    function testFuzz_monotonicity(
        ...
        uint256 count1 = JBCashOuts.cashOutCountFor(surplus, out1, totalSupply, cashOutTaxRate);
        uint256 count2 = JBCashOuts.cashOutCountFor(surplus, out2, totalSupply, cashOutTaxRate);
