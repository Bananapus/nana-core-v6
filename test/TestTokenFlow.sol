...
contract TestTokenFlow_Local is TestBaseWorkflow {
    ...
    function testFuzzTokenFlow(uint208 _mintAmount, uint256 _burnAmount, bool _issueToken) public {
        ...
        if (_issueToken) {
            ...
            _newToken.initialize({name: "NewTestName", symbol: "NewTestSymbol", tokensAddress: address(_tokens)});
        ...
        if (_mintAmount == 0) vm.expectPartialRevert(JBController.JBController_ZeroTokensToMint.selector);
