...
contract TestRulesetQueuing5_1_Local is TestBaseWorkflow {
    ...
    function testReconfigureProject() public {
        ...
        JBRuleset memory _ruleset = jbRulesets5_1().currentOf(projectId);
        ...
        _ruleset = jbRulesets5_1().currentOf(projectId);
        assertEq(_ruleset.cycleNumber, 1);
        ...
        JBRuleset memory _newRuleset = jbRulesets5_1().currentOf(projectId);
    ...
    function testMultipleQueuedOnCycledOver() public {
        ...
        JBRuleset memory queuedRuleset = jbRulesets5_1().upcomingOf(projectId);
    ...
    function testMultipleReconfigure(uint8 _deadlineDuration) public {
        ...
        JBRuleset memory initialRuleset = jbRulesets5_1().currentOf(projectId);
        JBRuleset memory currentRuleset = initialRuleset;
        JBRuleset memory upcomingRuleset = jbRulesets5_1().upcomingOf(projectId);
        ...
        for (uint256 i = 0; i < _RULESET_DURATION_DAYS + 1; i++) {
            ...
            currentRuleset = jbRulesets5_1().currentOf(projectId);
            upcomingRuleset = jbRulesets5_1().upcomingOf(projectId);

            // Get a list of queued rulesets
            JBRuleset[] memory rulesetsOf = jbRulesets5_1().allOf(projectId, 0, 1);
    ...
    function testQueueShortDurationProject() public {
        ...
        _newRuleset = jbRulesets5_1().currentOf(projectId);
    ...
    function testMixedStarts() public {
        ...
        JBRuleset memory _queued = jbRulesets5_1().upcomingOf(projectId);
        assertEq(_queued.cycleNumber, 2);
        assertEq(_queued.id, _initialRulesetId + 1);
        assertEq(_queued.weight, _weightFirstQueued);

        // Get a list of queued rulesets
        JBRuleset[] memory queuedRulesets = jbRulesets5_1().allOf(projectId, 0, 1);
        ...
        JBRuleset memory _requeued = jbRulesets5_1().upcomingOf(projectId);
        assertEq(_requeued.cycleNumber, 2);
        assertEq(_requeued.id, _initialRulesetId);
        assertEq(_requeued.weight, _weightInitial);

        // Get a list of queued rulesets
        JBRuleset[] memory queuedRulesets2 = jbRulesets5_1().allOf(projectId, 0, 1);
        ...
        JBRuleset memory _initialIsCurrent = jbRulesets5_1().currentOf(projectId);
        ...
        JBRuleset memory _requeued2 = jbRulesets5_1().upcomingOf(projectId);
        ...
        // Get queued rulesets
        JBRuleset[] memory queuedRulesets3 = jbRulesets5_1().allOf(projectId, 0, 1);
    ...
    function testSingleBlockOverwriteQueued() public {
        ...
        JBRuleset memory queuedToOverwrite = jbRulesets5_1().upcomingOf(projectId);
        ...
        JBRuleset memory queued = jbRulesets5_1().upcomingOf(projectId);
    ...
    function testRulesetViewAccuracy() public {
        ...
        // Get a list of queued rulesets
        JBRuleset[] memory rulesetsOf = jbRulesets5_1().allOf(id, 0, 3);
        ...
        // Get a list of queued rulesets
        rulesetsOf = jbRulesets5_1().allOf(id, 0, 2);
        ...
        // Get a list of queued rulesets
        rulesetsOf = jbRulesets5_1().allOf(id, upcomingRuleset.id, 2);
        ...
        // Get a list of queued rulesets
        rulesetsOf = jbRulesets5_1().allOf(id, upcomingRuleset.id, 1);
        ...
        rulesetsOf = jbRulesets5_1().allOf(id, 0, 10);
    ...
    function testWithThreeHistoricalRulesets() public {
        ...
        // Get a list of queued rulesets
        JBRuleset[] memory rulesetsOf = jbRulesets5_1().allOf(projectId, 0, 3);

        // check: three rulesets returned
        assertEq(rulesetsOf.length, 3);

        // get the current ruleset
        JBRuleset memory currentRuleset = jbRulesets5_1().currentOf(projectId);
    ...
    function testZeroDurationWithDeadlineHookQueuing() public {
...

        {
            ...
            JBRuleset memory _currentRuleset = jbRulesets5_1().currentOf(projectId);
...

        {
            ...
            JBRuleset memory _upcomingRuleset = jbRulesets5_1().upcomingOf(projectId);
...

        {
            ...
            JBRuleset[] memory _allRulesets = jbRulesets5_1().allOf(projectId, 0, 3);
