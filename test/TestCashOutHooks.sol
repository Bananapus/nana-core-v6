...
contract TestCashOutHooks_Local is TestBaseWorkflow {
    ...
    function testCashOutHookWithFeesAndCustomInfo() public {
        ...
        uint256 _forwardedAmount = _halfPaid - (_halfPaid * JBConstants.STANDARD_FEE / JBConstants.MAX_FEE);
        ...
        _beneficiaryAmount -= mulDiv(_beneficiaryAmount, JBConstants.STANDARD_FEE, JBConstants.MAX_FEE);
