...
contract TestUseAllowanceOf5_1_Local is JBMultiTerminalSetup5_1 {
    ...
    function test_WhenNotFeeless() external {
        ...
        mockExpect(address(controller), abi.encodeCall(IJBController.currentRulesetOf, (_projectId)), abi.encode(returnedRuleset, generateEmptyMetadata()));
