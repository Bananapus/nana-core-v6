...
contract TestPay5_1_Local is JBMultiTerminalSetup5_1 {
    uint64 _projectId = 1;
    ...
    modifier whenNativeTokenIsAccepted() {
        ...
        mockExpect(address(this), abi.encodeCall(IJBController.currentRulesetOf, (_projectId)), abi.encode(returnedRuleset, generateEmptyMetadata()));
    ...
    modifier whenERC20IsAccepted() {
        ...
        mockExpect(address(this), abi.encodeCall(IJBController.currentRulesetOf, (_projectId)), abi.encode(ruleset, generateEmptyMetadata()));
