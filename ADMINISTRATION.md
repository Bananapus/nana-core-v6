...
- The production ratio-feed rollout has executed on Ethereum, Optimism, Base, and Arbitrum. Verify each chain's recorded receipt and live registered pairs independently; OP Sepolia also has the feed, independently of the absent Uniswap stack
