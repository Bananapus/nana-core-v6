...
/// and the split targets a project, the terminal defaults to `msg.sender` as the token recipient — always set an
/// explicit beneficiary when routing tokens to a project.
