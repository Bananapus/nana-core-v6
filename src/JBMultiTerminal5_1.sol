...
import {IJBMultiTerminal5_1} from "./interfaces/IJBMultiTerminal5_1.sol";
...
import {IJBTerminalStore5_1} from "./interfaces/IJBTerminalStore5_1.sol";
...
contract JBMultiTerminal5_1 is JBPermissioned, ERC2771Context, IJBMultiTerminal5_1 {
    ...
    IJBTerminalStore5_1 public immutable override STORE;
    ...
    function supportsInterface(bytes4 interfaceId) public pure override returns (bool) {
        return interfaceId == type(IJBMultiTerminal5_1).interfaceId || interfaceId == type(IJBPermissioned).interfaceId
            ...
            || interfaceId == type(IJBMultiTerminal5_1).interfaceId || interfaceId == type(IJBFeeTerminal).interfaceId
        ...
        override
    {
        ...
        _requirePermissionAllowingOverrideFrom({
            ...
            alsoGrantAccessIf: _msgSender() == address(controller)
        });
