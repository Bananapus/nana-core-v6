...
contract JBTerminalStore5_1 is IJBTerminalStore5_1 {
    ...
    constructor(IJBDirectory directory, IJBPrices prices) {
        DIRECTORY = directory;
        PRICES = prices;
    }
        ...
        returns (uint256)
    {
        ...
        (JBRuleset memory ruleset,) = IJBController(address(DIRECTORY.controllerOf(projectId))).currentRulesetOf(projectId);
