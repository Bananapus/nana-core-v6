...
library JBFees {
    ...
    /// @dev If a nonzero amount and nonzero fee would otherwise round down to zero, returns 1 so feeable dust
    /// payouts cannot bypass protocol fees by splitting across tiny transfers.
